 ...
 const nextWeek = new Date(today.getTime() + 7 * 24 * 60 * 60 * 1000); // Permet d'ajouter 7 jours à la date du jour

 let day = ('0' + nextWeek).slice(9,11); // Permet de transformer l'objet date en chaine de caractère
 let month = ('0' + (today.getMonth() + 1)).slice(-2); // Permet d'obtenir le mois , l'objet date débute les mois à 0 (d'où le +1)
